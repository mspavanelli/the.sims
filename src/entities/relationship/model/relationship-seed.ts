  ...
  characters: [
    {
      ...
      traits: ["Analítico", "Calmo", "Curioso"],
      interests: ["Cozinhar", "Ciclismo", "Jogos de tabuleiro", "Astronomia"],
      likes: ["Massas frescas", "Vinil", "Feiras de rua", "Estrelas"],
      quirks: [
        "Transforma qualquer assunto em mapa mental",
        "Explica curiosidades históricas do nada",
        "Lê placas por diversão",
        "Faz trocadilhos ruins",
        "Nomeia as plantas",
      ],
      affectionStyles: ["Atos de cuidado", "Cozinhar junto", "Toque"],
      energySources: ["Pedalar ao amanhecer", "Boa comida", "Silêncio compartilhado"],
      energyDrains: ["Calor", "Excesso de barulho", "Ambientes caóticos", "Interrupções constantes"],
    ...
    },
    {
      ...
      bio: "Enxerga beleza nos detalhes que ninguém repara e transforma o que sente em cerâmica, foto e pequenos rituais. Independente, sonhadora, e feliz de um jeito quieto quando chove.",
      mbti: "INTP",
      today: { emoji: "🏺", text: "inspirada com cerâmica" },
      traits: ["Curiosa", "Independente", "Sonhadora"],
      ...
      quirks: [
        "Fala com plantas",
        "Guarda ingressos de tudo",
        "Fotografa detalhes que ninguém nota",
        "Sorri quando começa a chover",
        "Canta desafinado feliz",
      ],
      affectionStyles: ["Palavras carinhosas", "Tempo de qualidade", "Bilhetinhos"],
      energySources: ["Manhãs sem pressa", "Mar", "Abraço demorado"],
      energyDrains: ["Pressa", "Agendas lotadas", "Multidões barulhentas", "Despedidas corridas"],
